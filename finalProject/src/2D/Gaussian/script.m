...
delete(['figure\points_n_' num2str(size(P,1)) '_Points_rect_' num2str(num_point) '_Rrbf_' num2str(r_rbf) '_poly_' num2str(coeff_poly) '.jpg']);
...
delete(['figure\implicit_function_n_' num2str(size(P,1)) '_Points_rect_' num2str(num_point) '_Rrbf_' num2str(r_rbf) '_poly_' num2str(coeff_poly) '.jpg']);
